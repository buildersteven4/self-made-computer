...
\caption{Instruction Layout}
\begin{tikzpicture}
\draw [thick] (0,0) rectangle (8,-1) node[pos=.5] {\# (16)};
\node[above] at (0, 0) {31};
\node[above] at (8, 0) {16};
\draw [thick] (0.0,-1) rectangle (2.5,-2) node[pos=.5] {B (5)};
\node[below] at (0, -2) {15};
\node[below] at (2.5, -2) {10};
\draw [thick] (2.5,-1) rectangle (5,-2) node[pos=.5] {A (5)};
\node[below] at (5.0, -2) {5};
\draw [thick] (5.0,-1) rectangle (8,-2) node[pos=.5] {OP (6)};
\node[below] at (8.0, -2) {0};
\end{tikzpicture}
\end{center}
\end{figure}
