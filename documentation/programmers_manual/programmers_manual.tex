...
\begin{table}[h]
\centering
\caption{List of Normal Operands}
\label{tab:List of Normal Operands}
\begin{tabular}{cclc}
\hiderowcolors
\multirow{2}{*}{\textbf{ID}} & \multicolumn{2}{c}{\textbf{Foreground Registers}} & \multirow{2}{*}{\textbf{Length in bits}}\\
                             & \textbf{Mnonic} & \textbf{Descriptive Name}       & \\ \hline
\showrowcolors
0x0 & al & The lower byte of ax  & 8  \\
0x1 & ah & The higher byte of ax & 8  \\
0x2 & bl & The lower byte of bx  & 8  \\
