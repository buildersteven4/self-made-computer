...
\section{#1} % The name of the instrunction
Opcode: #2
\subsection*{Usages}
\ifthenelse{\equal{#3}{}}{#1 a b}{#3}
...
\begin{algorithmic}
\If {$x = y$} \Comment Where x and y were the operands of a previous calculation
    \State $a\gets b$
\EndIf
\end{algorithmic}
}{none}
...
alternative pseudocode:
\begin{algorithmic}
\If {$x \not= y$} \Comment Where x and y were the operands of a previous calculation
    \State $a\gets b$
\EndIf
\end{algorithmic}
}{none}

\instruction{MOVS}{0x02}{
MOVS a b
}{
